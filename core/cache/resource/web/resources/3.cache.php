<?php  return array (
  ...
  array (
    ...
    'isfolder' => 1,
    'introtext' => '',
    'content' => '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla blandit volutpat dolor, ac convallis massa mattis at. Donec facilisis tempor metus, auctor viverra augue sollicitudin a. Quisque porta diam massa, sed scelerisque purus posuere et. Cras dictum eget ligula eu tristique. Etiam eget tortor erat. Aliquam suscipit facilisis commodo. Pellentesque a euismod enim, sed pulvinar ipsum. Sed posuere odio quis nisl egestas, rutrum vulputate justo blandit. Phasellus quis sapien libero.</p>
<p>Nullam dapibus velit imperdiet tellus finibus, ut aliquet ipsum tristique. Vivamus dapibus at tellus nec cursus. Nam sodales egestas leo et pretium. Aenean elit velit, scelerisque id varius eu, molestie in lorem. Vestibulum eget quam molestie, finibus massa et, semper sapien. Integer rhoncus aliquet lorem sit amet ultrices. Phasellus placerat mattis odio id aliquet.</p>
<p>Vivamus a enim dolor. Donec tristique, erat interdum porttitor volutpat, mi metus iaculis ante, non feugiat dolor dui id felis. Quisque tristique diam ac tellus suscipit, vel tincidunt augue ornare. Duis facilisis ligula mi, sed accumsan lacus congue ac. Fusce blandit bibendum quam, id ultricies metus imperdiet vel. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. In rutrum accumsan erat, lobortis placerat dolor congue ac. Quisque condimentum, ligula non tristique viverra, lacus turpis auctor urna, eget auctor orci risus luctus sem. Sed enim libero, sollicitudin vitae quam ac, ultricies gravida est. Duis laoreet neque a malesuada sodales. Donec fermentum non ligula vel porta. Nam suscipit libero at ipsum convallis, eu auctor mauris tristique. Duis felis justo, fringilla convallis pharetra ac, vestibulum in arcu. Etiam aliquet fringilla bibendum.</p>
<p>Aliquam erat volutpat. Ut elementum felis vel tellus eleifend scelerisque. Cras blandit iaculis maximus. Nunc rhoncus magna in purus efficitur rhoncus. Proin vel sapien sed magna varius pharetra et in leo. Integer gravida aliquam urna in aliquam. Fusce pellentesque pharetra metus, et pretium quam efficitur vel. Duis tristique, ex vitae convallis porta, turpis dui volutpat ex, sed euismod dolor nibh convallis magna. Aliquam erat orci, blandit non placerat a, malesuada quis risus. Proin accumsan non nisi a mollis. Praesent varius in lectus sit amet pretium.</p>
<p>Ut varius, quam et rutrum bibendum, nulla risus dignissim eros, eget tempor tellus dolor at leo. Praesent vitae volutpat nulla. Quisque et risus at augue ornare semper. Maecenas auctor, augue id pretium sollicitudin, risus felis euismod velit, vehicula sodales purus tellus nec mauris. Donec mauris mi, pharetra quis justo quis, tempus ultrices dolor. Quisque tempor finibus felis, ac finibus dui rutrum non. Ut sed dictum felis, et tempor eros. In eu lacus pretium, molestie augue vitae, cursus odio. Ut eget scelerisque odio, eget finibus nulla. Donec blandit ultricies enim nec dapibus.</p>',
    'richtext' => 1,
    'template' => 2,
    'menuindex' => 2,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1542598960,
    'editedby' => 1,
    'editedon' => 1542751691,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1542598920,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<head>
    <base href="[[!++site_url]]" />
<meta charset="UTF-8">
<title>About us | LA Flooring Professionals</title>


<meta name="format-detection" content="telephone=no">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta property="og:image" content="assets/images/0987-229x95.png" />
<meta name="twitter:image:src" content="assets/images/0987-229x95.png" />
<meta itemprop="image" content="assets/images/0987-229x95.png" />
<link rel="image_src" href="assets/images/0987-229x95.png" />
    
  <link rel="shortcut icon" href="assets/images/0987-229x95.png" type="image/x-icon">
...
<body class="simple">
    <section class="menu cid-r9GXGSF1kO" once="menu" id="menu2-1">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="http://floor.egocosm.tmweb.ru/">
                        <img src="assets/images/0987-229x95.png" alt="Mobirise" title="" style="height: 3.8rem;">
                    </a>
                </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul style="margin: 0 auto;" class=" navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="first nav-item"><a class="nav-link link text-black display-4" href="http://floor.egocosm.tmweb.ru/" title="Home" >Home</a></li>
<li class=" nav-item"><a class="nav-link link text-black display-4" href="services/" title="Services" >Services</a></li>
<li class="active nav-item"><a class="nav-link link text-black display-4" href="about-us/" title="About us" >About us</a></li>
<li class=" nav-item"><a class="nav-link link text-black display-4" href="reviews/" title="Reviews" >Reviews</a></li>
<li class="last nav-item"><a class="nav-link link text-black display-4" href="contacts-us.html" title="Contact us" >Contact us</a></li>
</ul>
    ...
    <ul class="B_crumbBox"><li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_homeCrumb" itemprop="url" rel="Home" href="http://floor.egocosm.tmweb.ru/"><span itemprop="title">Home</span></a></li>
  <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">About us</li></li>
</ul>
    
    
    <br>
<section class="features11 cid-r9HiZB98pu" id="features11-g">

    <div class="container">   
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/pergo-vinil-40056-1-952x1378.jpg" alt="Mobirise" title="">
                </div>
                <div class=" align-left aside-content">
                    ...
                    <div class="mbr-section-text">
                        ...
                        The right choice of flooring is the first step to creating a functional and beautiful interior. Our review will help to take into account all the pros and cons of the most common flooring and choose the most preferred option for you and your apartment.</p>
                    </div>
                    ...
                    <div class="block-content">
                        <div class="card p-3 pr-3">
                            <div class="media">
                                <div class=" align-self-center card-img pb-3">
                                    <span class="mbr-iconfont mbri-protect" style="color: rgb(83, 116, 217); fill: rgb(83, 116, 217);"></span>
                                </div>     
                                <div class="media-body">
                                    <h4 class="card-title mbr-fonts-style display-7">High quality floors</h4>
                                </div>
                            </div>                

                            <div class="card-box">
                                <p class="block-text mbr-fonts-style display-7">The first two of them, despite the apparent difference, have many similar characteristics. They are made of wood (often valuable species) and therefore, quite expensive.&nbsp;</p>
                            </div>
                        </div>
                        ...
                        <div class="card p-3 pr-3">
                            <div class="media">
                                <div class="align-self-center card-img pb-3">
                                    <span class="mbr-iconfont mbri-extension" style="color: rgb(83, 116, 217); fill: rgb(83, 116, 217);"></span>
                                </div>     
                                <div class="media-body">
                                    <h4 class="card-title mbr-fonts-style display-7">Long service life</h4>
                                </div>
                            </div>                

                            <div class="card-box">
                                <p class="block-text mbr-fonts-style display-7">The advantages of solid wood and parquet are their long service life (over 50 years), versatility, good thermal insulation properties.
                                </p>
                            </div>
                        </div>
                    </div>
...
<section class="features16 cid-r9ZjmeHVpQ" id="features16-1n">
    ...
    <div class="container align-center">
        ...
        <h3 class="pb-5 mbr-section-subtitle mbr-fonts-style mbr-light display-5">
            Own production, all products are certified and meet the standards, quality products and long service life, as well low price, profitability.
        </h3>
        <div class="row media-row">
        <div class="team-item col-lg-3 col-md-6">
    <div class="item-image">
        <img src="/assets/components/phpthumbof/cache/face6.3cc6b0df862d1514430c85d44c608a573.jpg">
    </div>
...
<section class="mbr-section article content1 cid-r9O8cxOcZJ" id="content1-1l">
    <div class="container">
        <div class="media-container-row">
...
<p>Ut varius, quam et rutrum bibendum, nulla risus dignissim eros, eget tempor tellus dolor at leo. Praesent vitae volutpat nulla. Quisque et risus at augue ornare semper. Maecenas auctor, augue id pretium sollicitudin, risus felis euismod velit, vehicula sodales purus tellus nec mauris. Donec mauris mi, pharetra quis justo quis, tempus ultrices dolor. Quisque tempor finibus felis, ac finibus dui rutrum non. Ut sed dictum felis, et tempor eros. In eu lacus pretium, molestie augue vitae, cursus odio. Ut eget scelerisque odio, eget finibus nulla. Donec blandit ultricies enim nec dapibus.</p>
    ...
    <section class="mbr-section form1 cid-r9HA8NkyYb mbr-parallax-background" id="form1-o">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2"><strong>Get
 a quote from our experts</strong></h2>
    ...
    &form=`orderLetter`
    &formName=`Get a quote from our experts`
    &formFields=`name,email,phone,text`
    &fieldNames=`name==Имя отправителя,phone=Телефон,email==Эл.почта отправителя,text==Комментарий отправителя`
    &submitVar=`btn`
    &emailTo=`alexey.kurokhtin@gmail.com`
	&emailTpl=`orderform-email`
	&emailFromName =`"LA Flooring Professionals"`
	&frontend_js=`themes/js/order.js`
    &validate=`nospam:blank,
        phone:required,
        email:email:required`
    &validationErrorMessage=`Please fill in the fields correctly`
    &emailSubject=`LA Flooring Professionals`
]]
            </div>
        </div>
    </div>
</section>
    <section class="cid-r9HCkSRO2n mbr-reveal" id="footer1-p">
    ...
    <div class="container">
        <div class="media-container-row content text-white">
            <div class="col-12 col-md-3">
                <div class="media-wrap">
                    <a href="https://mobirise.co/">
                        <img src="assets/images/1234-268x116.png" alt="Mobirise" title="">
                    </a>
                </div>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                ...
                <p class="mbr-text">Los Angeles, 2893, <br>190th Street</p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <h5 class="pb-3">
                    Contacts us</h5>
                <p class="mbr-text">
                    Email: laflooringpros.com<br>Phone: 1 (234) 500 8901<br><br></p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7 footer_menu">
                <ul style="margin: 0 auto;" class=" navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="first nav-item"><a class="nav-link link text-black display-4" href="http://floor.egocosm.tmweb.ru/" title="Home" >Home</a></li>
<li class=" nav-item"><a class="nav-link link text-black display-4" href="services/" title="Services" >Services</a></li>
<li class="active nav-item"><a class="nav-link link text-black display-4" href="about-us/" title="About us" >About us</a></li>
<li class=" nav-item"><a class="nav-link link text-black display-4" href="reviews/" title="Reviews" >Reviews</a></li>
        ...
        <div class="footer-lower">
            ...
            <div class="media-container-row mbr-white">
                <div class="col-sm-6 copyright">
                    <p class="mbr-text mbr-fonts-style display-4"><br><br>© Copyright 2018 LA Flooring Professional - All rights reserved &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>
                </div>
                <div class="col-md-6">
...
<script src="assets/web/assets/jquery/jquery.min.js"></script>
  ...
  array (
    '[[*pagetitle]]' => 'About us',
    '[[*longtitle:ifempty=`About us | LA Flooring Professionals`]]' => 'About us | LA Flooring Professionals',
    '[[*id:is=`1`:then=`LA Flooring Professionals`:else=`[[*longtitle:ifempty=`[[*pagetitle]] | LA Flooring Professionals`]]`]]' => '[[*longtitle:ifempty=`[[*pagetitle]] | LA Flooring Professionals`]]',
    '[[*description]]' => '',
...
<link rel="image_src" href="assets/images/0987-229x95.png" />
  ...
  <link rel="stylesheet" href="themes/css/style.css" type="text/css">
  <link rel="stylesheet" href="/themes/fancybox-3.2/jquery.fancybox.min.css" />',
    '[[Wayfinder? &startId=`0` &level=`1` &rowTpl=`rowTpl` &outerTpl=`outerTpl`]]' => '<ul style="margin: 0 auto;" class=" navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="first nav-item"><a class="nav-link link text-black display-4" href="http://floor.egocosm.tmweb.ru/" title="Home" >Home</a></li>
<li class=" nav-item"><a class="nav-link link text-black display-4" href="services/" title="Services" >Services</a></li>
<li class="active nav-item"><a class="nav-link link text-black display-4" href="about-us/" title="About us" >About us</a></li>
<li class=" nav-item"><a class="nav-link link text-black display-4" href="reviews/" title="Reviews" >Reviews</a></li>
<li class="last nav-item"><a class="nav-link link text-black display-4" href="contacts-us.html" title="Contact us" >Contact us</a></li>
</ul>',
    '[[$menu]]' => '<section class="menu cid-r9GXGSF1kO" once="menu" id="menu2-1">
...
<li class="last nav-item"><a class="nav-link link text-black display-4" href="contacts-us.html" title="Contact us" >Contact us</a></li>
    ...
    '[[$?text=`About us`]]' => '<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">About us</li>',
    '[[~1]]' => 'http://floor.egocosm.tmweb.ru/',
    '[[$?description=`Home`&text=`Home`]]' => '<a class="B_homeCrumb" itemprop="url" rel="Home" href="http://floor.egocosm.tmweb.ru/"><span itemprop="title">Home</span></a>',
    '[[$?text=`<a class="B_homeCrumb" itemprop="url" rel="Home" href="http://floor.egocosm.tmweb.ru/"><span itemprop="title">Home</span></a>`]]' => '<li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_homeCrumb" itemprop="url" rel="Home" href="http://floor.egocosm.tmweb.ru/"><span itemprop="title">Home</span></a></li>',
    '[[$?text=`<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">About us</li>`]]' => '<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">About us</li></li>',
    '[[$?text=`<li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_homeCrumb" itemprop="url" rel="Home" href="http://floor.egocosm.tmweb.ru/"><span itemprop="title">Home</span></a></li>
  <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">About us</li></li>
`]]' => '<ul class="B_crumbBox"><li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_homeCrumb" itemprop="url" rel="Home" href="http://floor.egocosm.tmweb.ru/"><span itemprop="title">Home</span></a></li>
  <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">About us</li></li>
</ul>',
    '[[Breadcrumbs? &crumbSeparator=`` &currentAsLink=`0`]]' => '<ul class="B_crumbBox"><li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_homeCrumb" itemprop="url" rel="Home" href="http://floor.egocosm.tmweb.ru/"><span itemprop="title">Home</span></a></li>
  <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">About us</li></li>
</ul>',
    '[[*id:is=`2`:then=`class="features15 cid-r9NXv3yVQA" id="features15-z""`:else=`class="features15 cid-r9HMmDkZjL" id="features15-t"`]]' => 'class="features15 cid-r9HMmDkZjL" id="features15-t"',
    '[[getResourceField? &id=`2` &field=`introtext`]]' => 'A huge collection of the best wooden materials which satisfy everyone’s needs, <br>even the most demanding projects',
    '[[~12]]' => 'services/vinyl-plank-flooring.html',
    '[[~8]]' => 'services/reclaimed-flooring.html',
    '[[~7]]' => 'services/parquet.html',
    '[[~6]]' => 'services/european-oak.html',
    '[[getResources? &parents=`2` &tpl=`servicesTpl` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &sortby=`{"menuindex":"DESC"}` &limit=``]]' => '<a href="services/vinyl-plank-flooring.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/vinyl-plank-flooring-2.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
        <div class="card_back card_cont">
            <h4 class="card-title display-5 py-2 mbr-fonts-style">Vinyl Plank Flooring</h4>
            <p class="mbr-text mbr-fonts-style display-7">Luxury vinyl plank (LVP) is an affordable waterproof wood-look flooring option that has great warmth and texture underfoot and installs with peel-and-stick, glue-down, or click-together ease.</p>
            <span class="link_more">see more</span>
        </div>
    </div>
</a>
<a href="services/reclaimed-flooring.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/hjfc-jhfc-1200x929.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
        <div class="card_back card_cont">
            <h4 class="card-title display-5 py-2 mbr-fonts-style">Reclaimed Flooring</h4>
            <p class="mbr-text mbr-fonts-style display-7">The characteristics of the floor — color, coating, texture, pattern, and hardness — depend largely on the type of wood — from light, calm maple, beech</p>
            <span class="link_more">see more</span>
        </div>
    </div>
</a>
<a href="services/parquet.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/17552-603x328.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
        <div class="card_back card_cont">
            <h4 class="card-title display-5 py-2 mbr-fonts-style">Parquet</h4>
            <p class="mbr-text mbr-fonts-style display-7">The floor is the basis, and if it is always possible to change the color of the walls and ceiling, then by nature the floor is more 
permanent</p>
            <span class="link_more">see more</span>
        </div>
    </div>
</a>
<a href="services/european-oak.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/1-175-1200x836.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
        <div class="card_back card_cont">
            <h4 class="card-title display-5 py-2 mbr-fonts-style">European Oak</h4>
            <p class="mbr-text mbr-fonts-style display-7">The floor is crucial for the whole interior of the room. It is with the choice of gender should begin the development of design</p>
            <span class="link_more">see more</span>
        </div>
    </div>
</a>',
    '[[getResources? &parents=`2` &tpl=`servicesTpl` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &sortby=`{"menuindex":"DESC"}` &limit=`3`]]' => '<a href="services/vinyl-plank-flooring.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/vinyl-plank-flooring-2.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
...
permanent</p>
    ...
    '[[*id:is=`2`:then=`<a href="services/vinyl-plank-flooring.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/vinyl-plank-flooring-2.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
...
</a>`:else=`<a href="services/vinyl-plank-flooring.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/vinyl-plank-flooring-2.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
...
</a>`]]' => '<a href="services/vinyl-plank-flooring.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/vinyl-plank-flooring-2.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
...
permanent</p>
    ...
    '[[$services]]' => '<section class="features15 cid-r9HMmDkZjL" id="features15-t">

    <div class="container">
        <h2 class="mbr-section-title pb-3 align-center mbr-fonts-style display-2">
            Services
        </h2>
        <h3 class="mbr-section-subtitle display-5 align-center mbr-fonts-style">A huge collection of the best wooden materials which satisfy everyone’s needs, <br>even the most demanding projects</h3>

        <div class="media-container-row container pt-5 mt-2">

            <a href="services/vinyl-plank-flooring.html" class="col-12 col-md-6 mb-4 col-lg-4">
    <div class="card flip-card p-5 align-center">
        <div class="card-front card_cont">
            <img src="/assets/components/phpthumbof/cache/vinyl-plank-flooring-2.4dbdb1940e63ae818c952273a6f945793.jpg" alt="Mobirise" title="">
        </div>
...
permanent</p>
    ...
    '[[getResources? &parents=`2` &tpl=`servicesDescriptionTpl` &sortby=`{"menuindex":"DESC"}` &limit=`` &includeContent=`1`]]' => '<li>
   <strong>Vinyl Plank Flooring</strong> -Luxury vinyl plank (LVP) is an affordable waterproof wood-look flooring option that has great warmth and texture underfoot and installs with peel-and-stick, glue-down, or click-together ease. <a href="services/vinyl-plank-flooring.html">Learn more!</a>
</li>
<li>
   <strong>Reclaimed Flooring</strong> -The characteristics of the floor — color, coating, texture, pattern, and hardness — depend largely on the type of wood — from light, calm maple, beech <a href="services/reclaimed-flooring.html">Learn more!</a>
</li>
<li>
   <strong>Parquet</strong> -The floor is the basis, and if it is always possible to change the color of the walls and ceiling, then by nature the floor is more 
permanent <a href="services/parquet.html">Learn more!</a>
</li>
<li>
   <strong>European Oak</strong> -The floor is crucial for the whole interior of the room. It is with the choice of gender should begin the development of design <a href="services/european-oak.html">Learn more!</a>
</li>',
    '[[$services_description]]' => '<section class="mbr-section content4 cid-r9O6wGYLNs" id="content4-1e">

    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">Our Services include</h2>
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">We offer many types of flooring to our clients, here are some examples of our work<div><br></div></h3>
...
<section class="mbr-section article content12 cid-r9O4u8PCUP" id="content12-1a">
...
<li>
   <strong>European Oak</strong> -The floor is crucial for the whole interior of the room. It is with the choice of gender should begin the development of design <a href="services/european-oak.html">Learn more!</a>
    ...
    '[[*id:is=`2`:then=`<section class="features15 cid-r9HMmDkZjL" id="features15-t">
...
</div></section><section class="mbr-section content4 cid-r9O6wGYLNs" id="content4-1e">
...
<li>
   <strong>European Oak</strong> -The floor is crucial for the whole interior of the room. It is with the choice of gender should begin the development of design <a href="services/european-oak.html">Learn more!</a>
    ...
    '[[*longtitle:ifempty=`We offer many types of flooring to our clients, here are some examples of our work.`]]' => 'We offer many types of flooring to our clients, here are some examples of our work.',
    '[[$title]]' => '<section class="mbr-section content4 cid-r9O7y7icdf" id="content4-1i">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">We offer many types of flooring to our clients, here are some examples of our work.
<div></div></h3>
    ...
    '[[*album]]' => '2',
    '[[*album:notempty=`<section class="mbr-gallery mbr-slider-carousel cid-r9O7JQleK9" id="gallery3-1j">
    ...
    <div>
        ...
        <div>
        [[!Gallery? &album=`2` &thumbTpl=`thumbTpl` &thumbWidth=`900` &thumbHeight=`500` &thumbZoomCrop=`1`]]
        ...
        <div data-app-prevent-settings="" class="mbr-slider modal fade carousel slide" tabindex="-1" data-keyboard="true" data-interval="false" id="lb-gallery3-1j">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-body"><div class="carousel-inner">
                [[!Gallery? &album=`2` &thumbTpl=`lightboxTpl` &thumbWidth=`1920` &thumbHeight=`768` &thumbZoomCrop=`0`]]
        </div><a class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#lb-gallery3-1j"><span class="mbri-left mbr-iconfont" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control carousel-control-next" role="button" data-slide="next" href="#lb-gallery3-1j"><span class="mbri-right mbr-iconfont" aria-hidden="true"></span><span class="sr-only">Next</span></a><a class="close" href="#" role="button" data-dismiss="modal"><span class="sr-only">Close</span></a></div></div></div></div></div>
    </div>

</section>`]]' => '<section class="mbr-gallery mbr-slider-carousel cid-r9O7JQleK9" id="gallery3-1j">
    ...
    '[[$album]]' => '<section class="mbr-gallery mbr-slider-carousel cid-r9O7JQleK9" id="gallery3-1j">
    ...
    '[[*content:notempty=`<section class="mbr-section article content1 cid-r9O8cxOcZJ" id="content1-1l">
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-12 mbr-fonts-style display-7">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla blandit volutpat dolor, ac convallis massa mattis at. Donec facilisis tempor metus, auctor viverra augue sollicitudin a. Quisque porta diam massa, sed scelerisque purus posuere et. Cras dictum eget ligula eu tristique. Etiam eget tortor erat. Aliquam suscipit facilisis commodo. Pellentesque a euismod enim, sed pulvinar ipsum. Sed posuere odio quis nisl egestas, rutrum vulputate justo blandit. Phasellus quis sapien libero.</p>
...
</section>`]]' => '<section class="mbr-section article content1 cid-r9O8cxOcZJ" id="content1-1l">
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-12 mbr-fonts-style display-7">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla blandit volutpat dolor, ac convallis massa mattis at. Donec facilisis tempor metus, auctor viverra augue sollicitudin a. Quisque porta diam massa, sed scelerisque purus posuere et. Cras dictum eget ligula eu tristique. Etiam eget tortor erat. Aliquam suscipit facilisis commodo. Pellentesque a euismod enim, sed pulvinar ipsum. Sed posuere odio quis nisl egestas, rutrum vulputate justo blandit. Phasellus quis sapien libero.</p>
...
<p>Ut varius, quam et rutrum bibendum, nulla risus dignissim eros, eget tempor tellus dolor at leo. Praesent vitae volutpat nulla. Quisque et risus at augue ornare semper. Maecenas auctor, augue id pretium sollicitudin, risus felis euismod velit, vehicula sodales purus tellus nec mauris. Donec mauris mi, pharetra quis justo quis, tempus ultrices dolor. Quisque tempor finibus felis, ac finibus dui rutrum non. Ut sed dictum felis, et tempor eros. In eu lacus pretium, molestie augue vitae, cursus odio. Ut eget scelerisque odio, eget finibus nulla. Donec blandit ultricies enim nec dapibus.</p>
    ...
    '[[$content]]' => '<section class="mbr-section article content1 cid-r9O8cxOcZJ" id="content1-1l">
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-12 mbr-fonts-style display-7">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla blandit volutpat dolor, ac convallis massa mattis at. Donec facilisis tempor metus, auctor viverra augue sollicitudin a. Quisque porta diam massa, sed scelerisque purus posuere et. Cras dictum eget ligula eu tristique. Etiam eget tortor erat. Aliquam suscipit facilisis commodo. Pellentesque a euismod enim, sed pulvinar ipsum. Sed posuere odio quis nisl egestas, rutrum vulputate justo blandit. Phasellus quis sapien libero.</p>
...
<p>Ut varius, quam et rutrum bibendum, nulla risus dignissim eros, eget tempor tellus dolor at leo. Praesent vitae volutpat nulla. Quisque et risus at augue ornare semper. Maecenas auctor, augue id pretium sollicitudin, risus felis euismod velit, vehicula sodales purus tellus nec mauris. Donec mauris mi, pharetra quis justo quis, tempus ultrices dolor. Quisque tempor finibus felis, ac finibus dui rutrum non. Ut sed dictum felis, et tempor eros. In eu lacus pretium, molestie augue vitae, cursus odio. Ut eget scelerisque odio, eget finibus nulla. Donec blandit ultricies enim nec dapibus.</p>
    ...
    '[[$one_service]]' => '<section class="mbr-section content4 cid-r9O7y7icdf" id="content4-1i">
...
<section class="mbr-gallery mbr-slider-carousel cid-r9O7JQleK9" id="gallery3-1j">
...
<p>Ut varius, quam et rutrum bibendum, nulla risus dignissim eros, eget tempor tellus dolor at leo. Praesent vitae volutpat nulla. Quisque et risus at augue ornare semper. Maecenas auctor, augue id pretium sollicitudin, risus felis euismod velit, vehicula sodales purus tellus nec mauris. Donec mauris mi, pharetra quis justo quis, tempus ultrices dolor. Quisque tempor finibus felis, ac finibus dui rutrum non. Ut sed dictum felis, et tempor eros. In eu lacus pretium, molestie augue vitae, cursus odio. Ut eget scelerisque odio, eget finibus nulla. Donec blandit ultricies enim nec dapibus.</p>
    ...
    '[[*parent:is=`2`:then=`<section class="mbr-section content4 cid-r9O7y7icdf" id="content4-1i">
...
<p>Ut varius, quam et rutrum bibendum, nulla risus dignissim eros, eget tempor tellus dolor at leo. Praesent vitae volutpat nulla. Quisque et risus at augue ornare semper. Maecenas auctor, augue id pretium sollicitudin, risus felis euismod velit, vehicula sodales purus tellus nec mauris. Donec mauris mi, pharetra quis justo quis, tempus ultrices dolor. Quisque tempor finibus felis, ac finibus dui rutrum non. Ut sed dictum felis, et tempor eros. In eu lacus pretium, molestie augue vitae, cursus odio. Ut eget scelerisque odio, eget finibus nulla. Donec blandit ultricies enim nec dapibus.</p>
    ...
    '[[$about]]' => '<section class="features11 cid-r9HiZB98pu" id="features11-g">
    ...
    '[[getResources? &parents=`3` &tpl=`teamTpl` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &sortby=`{"menuindex":"DESC"}` &limit=``]]' => '<div class="team-item col-lg-3 col-md-6">
    <div class="item-image">
        <img src="/assets/components/phpthumbof/cache/face6.3cc6b0df862d1514430c85d44c608a573.jpg">
    </div>
    <div class="item-caption py-3">
...
<p>Ut varius, quam et rutrum bibendum, nulla risus dignissim eros, eget tempor tellus dolor at leo. Praesent vitae volutpat nulla. Quisque et risus at augue ornare semper. Maecenas auctor, augue id pretium sollicitudin, risus felis euismod velit, vehicula sodales purus tellus nec mauris. Donec mauris mi, pharetra quis justo quis, tempus ultrices dolor. Quisque tempor finibus felis, ac finibus dui rutrum non. Ut sed dictum felis, et tempor eros. In eu lacus pretium, molestie augue vitae, cursus odio. Ut eget scelerisque odio, eget finibus nulla. Donec blandit ultricies enim nec dapibus.</p>
    ...
    '[[getResources? &parents=`4` &tpl=`revTpl` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &sortby=`{"menuindex":"DESC"}` &limit=``]]' => '<div class="mbr-testimonial p-3 align-center col-12 col-md-6 col-lg-4">
    <div class="panel-item p-3" style="height: 100%;">
        <div class="card-block">
            <div class="testimonial-photo">
                <img src="/assets/components/phpthumbof/cache/face3.6cd1f216c76fddb40f5a74616d69f6b33.jpg" alt="" title="">
            </div>
            <p class="mbr-text mbr-fonts-style display-7">It’s just great that there are such competent, very responsible and professional managers. It was a pleasure to work !!!</p>
        </div>
...
<div class="mbr-testimonial p-3 align-center col-12 col-md-6 col-lg-4">
    <div class="panel-item p-3" style="height: 100%;">
        <div class="card-block">
            <div class="testimonial-photo">
                <img src="/assets/components/phpthumbof/cache/-200x2001.6cd1f216c76fddb40f5a74616d69f6b33.jpg" alt="" title="">
            </div>
            <p class="mbr-text mbr-fonts-style display-7">The end result is satisfied. Definitely I plan to continue purchasing at this store, because there are still interior doors ahead :)</p>
        </div>
        <div class="card-footer">
            <div class="mbr-author-name mbr-bold mbr-fonts-style display-7">
                 John
...
<div class="mbr-testimonial p-3 align-center col-12 col-md-6 col-lg-4">
    <div class="panel-item p-3" style="height: 100%;">
        <div class="card-block">
            <div class="testimonial-photo">
                <img src="/assets/components/phpthumbof/cache/-200x200.6cd1f216c76fddb40f5a74616d69f6b33.jpg" alt="" title="">
            </div>
            <p class="mbr-text mbr-fonts-style display-7">It was very pleasant to work with the manager Galina Alekseevna for all the time when ordering. </p>
        </div>
        <div class="card-footer">
            <div class="mbr-author-name mbr-bold mbr-fonts-style display-7">
                 Paula
...
<div class="mbr-testimonial p-3 align-center col-12 col-md-6 col-lg-4">
    <div class="panel-item p-3" style="height: 100%;">
        <div class="card-block">
            <div class="testimonial-photo">
                <img src="/assets/components/phpthumbof/cache/asd.6cd1f216c76fddb40f5a74616d69f6b33.jpg" alt="" title="">
            </div>
            <p class="mbr-text mbr-fonts-style display-7">It was very pleasant to work with the manager all the time when ordering. </p>
        </div>
        <div class="card-footer">
            <div class="mbr-author-name mbr-bold mbr-fonts-style display-7">
                 Ryan
    ...
    '[[$reviews_page]]' => '<section class="testimonials1 cid-r9HGZkKJef" id="testimonials1-r">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 align-center">
                ...
                <h3 class="mbr-section-subtitle mbr-light pb-3 mbr-fonts-style display-5">Reviews of our favorite customers</h3>
            </div>
        </div>
    </div>

    <div class="container pt-3 mt-2">
        <div class="media-container-row" style="align-items: stretch;">
            <div class="mbr-testimonial p-3 align-center col-12 col-md-6 col-lg-4">
    <div class="panel-item p-3" style="height: 100%;">
        <div class="card-block">
            <div class="testimonial-photo">
...
<div class="mbr-testimonial p-3 align-center col-12 col-md-6 col-lg-4">
    ...
    '[[*id:is=`4`:then=`<section class="testimonials1 cid-r9HGZkKJef" id="testimonials1-r">
...
<div class="mbr-testimonial p-3 align-center col-12 col-md-6 col-lg-4">
    ...
    '[[$contacts_wrap]]' => '<section class="features1 cid-r9ZlVjTK8e" id="features1-1u">
        ...
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-img pb-3">
                    <span class="mbr-iconfont mbri-mobile" style="color: rgb(83, 116, 217); fill: rgb(83, 116, 217);"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-5">Our contacts</h4>
                    <p class="mbr-text mbr-fonts-style display-7">Email: info@laflooringpros.com<br>Phone:  1 (234) 500 8901&nbsp;</p>
                </div>
            </div>

            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-img pb-3">
                    <span class="mbr-iconfont mbri-map-pin" style="color: rgb(83, 116, 217); fill: rgb(83, 116, 217);"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-5">Our address</h4>
                    <p class="mbr-text mbr-fonts-style display-7">Los Angeles, 2893, 
<br>190th Street</p>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-img pb-3">
                    <span class="mbr-iconfont mbri-globe" style="color: rgb(83, 116, 217); fill: rgb(83, 116, 217);"></span>
                </div>
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-5">
                        Social</h4>
                    <p class="mbr-text mbr-fonts-style display-7">Our facebook <a href="https://facebook.com" target="_blank">account</a><br>
                    Our youtube <a href="https://youtube.com" target="_blank">channel</a></p>
                </div>
            </div>
    ...
    '[[$map]]' => '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1649.9856070675683!2d-118.4517668417612!3d34.19821189514163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c297182fd4eff9%3A0x974cc23dd967f272!2s14554+Vose+St%2C+Van+Nuys%2C+CA+91405!5e0!3m2!1sru!2sus!4v1542753185747" width="100%" height="550" frameborder="0" style="border:0" allowfullscreen></iframe>',
    '[[$contacts]]' => '<section class="mbr-section content4 cid-r9O7y7icdf" id="content4-1i">
...
<section class="features1 cid-r9ZlVjTK8e" id="features1-1u">
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1649.9856070675683!2d-118.4517668417612!3d34.19821189514163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c297182fd4eff9%3A0x974cc23dd967f272!2s14554+Vose+St%2C+Van+Nuys%2C+CA+91405!5e0!3m2!1sru!2sus!4v1542753185747" width="100%" height="550" frameborder="0" style="border:0" allowfullscreen></iframe>',
    '[[*id:is=`5`:then=`<section class="mbr-section content4 cid-r9O7y7icdf" id="content4-1i">
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1649.9856070675683!2d-118.4517668417612!3d34.19821189514163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c297182fd4eff9%3A0x974cc23dd967f272!2s14554+Vose+St%2C+Van+Nuys%2C+CA+91405!5e0!3m2!1sru!2sus!4v1542753185747" width="100%" height="550" frameborder="0" style="border:0" allowfullscreen></iframe>`]]' => '',
    ...
    '[[$order]]' => '<section class="mbr-section form1 cid-r9HA8NkyYb mbr-parallax-background" id="form1-o">
 ...
 a quote from our experts</strong></h2>
    ...
    '[[*album:notempty=`<script src="assets/masonry/masonry.pkgd.min.js"></script>
    <script src="assets/gallery/player.min.js"></script>
    <script src="assets/gallery/script.js"></script>
    <script src="assets/imagesloaded/imagesloaded.pkgd.min.js"></script>`]]' => '<script src="assets/masonry/masonry.pkgd.min.js"></script>
    <script src="assets/gallery/player.min.js"></script>
    <script src="assets/gallery/script.js"></script>
    <script src="assets/imagesloaded/imagesloaded.pkgd.min.js"></script>',
    '[[$footer]]' => '<section class="cid-r9HCkSRO2n mbr-reveal" id="footer1-p">
...
<meta charset="UTF-8">
<title>[[*id:is=`1`:then=`[[++site_name]]`:else=`[[*longtitle:ifempty=`[[*pagetitle]] | [[++site_name]]`]]`]]</title>
  ...
  <link rel="stylesheet" href="/themes/fancybox-3.2/jquery.fancybox.min.css" />',
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section class="menu cid-r9GXGSF1kO" once="menu" id="menu2-1">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            [[Wayfinder? &startId=`0` &level=`1` &rowTpl=`rowTpl` &outerTpl=`outerTpl`]]
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="tel:+1-234-567-8901"><span class="mobi-mbri mobi-mbri-phone mbr-iconfont mbr-iconfont-btn"></span>
                    1 (234) 500 8901
                </a></div>
        </div>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="menu cid-r9GXGSF1kO" once="menu" id="menu2-1">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section [[*id:is=`2`:then=`class="features15 cid-r9NXv3yVQA" id="features15-z""`:else=`class="features15 cid-r9HMmDkZjL" id="features15-t"`]]>

    <div class="container">
        <h2 class="mbr-section-title pb-3 align-center mbr-fonts-style display-2">
            Services
        </h2>
        <h3 class="mbr-section-subtitle display-5 align-center mbr-fonts-style">[[getResourceField? &id=`2` &field=`introtext`]]</h3>

        <div class="media-container-row container pt-5 mt-2">

            [[*id:is=`2`:then=`[[getResources? &parents=`2` &tpl=`servicesTpl` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &sortby=`{"menuindex":"DESC"}` &limit=``]]`:else=`[[getResources? &parents=`2` &tpl=`servicesTpl` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &sortby=`{"menuindex":"DESC"}` &limit=`3`]]`]]
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section [[*id:is=`2`:then=`class="features15 cid-r9NXv3yVQA" id="features15-z""`:else=`class="features15 cid-r9HMmDkZjL" id="features15-t"`]]>
    ...
    <div class="container">
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section class="mbr-section content4 cid-r9O6wGYLNs" id="content4-1e">
...
<section class="mbr-section article content12 cid-r9O4u8PCUP" id="content12-1a">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ul>
                    [[getResources? &parents=`2` &tpl=`servicesDescriptionTpl` &sortby=`{"menuindex":"DESC"}` &limit=`` &includeContent=`1`]]
                </ul>
            </div>
        </div>
    </div>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="mbr-section content4 cid-r9O6wGYLNs" id="content4-1e">
...
[[$content]]',
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section class="mbr-section content4 cid-r9O7y7icdf" id="content4-1i">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">[[*longtitle:ifempty=`We offer many types of flooring to our clients, here are some examples of our work.`]]
<div></div></h3>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="mbr-section content4 cid-r9O7y7icdf" id="content4-1i">
...
<div></div></h3>
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '[[*album:notempty=`<section class="mbr-gallery mbr-slider-carousel cid-r9O7JQleK9" id="gallery3-1j">
    ...
    <div>
        ...
        <div class="mbr-gallery-row">
            <div class="mbr-gallery-layout-default"><div>
        <div>
        [[!Gallery? &album=`[[*album]]` &thumbTpl=`thumbTpl` &thumbWidth=`900` &thumbHeight=`500` &thumbZoomCrop=`1`]]
        </div></div><div class="clearfix"></div></div></div><!-- Lightbox -->
        <div data-app-prevent-settings="" class="mbr-slider modal fade carousel slide" tabindex="-1" data-keyboard="true" data-interval="false" id="lb-gallery3-1j">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-body"><div class="carousel-inner">
                [[!Gallery? &album=`[[*album]]` &thumbTpl=`lightboxTpl` &thumbWidth=`1920` &thumbHeight=`768` &thumbZoomCrop=`0`]]
        </div><a class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#lb-gallery3-1j"><span class="mbri-left mbr-iconfont" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control carousel-control-next" role="button" data-slide="next" href="#lb-gallery3-1j"><span class="mbri-right mbr-iconfont" aria-hidden="true"></span><span class="sr-only">Next</span></a><a class="close" href="#" role="button" data-dismiss="modal"><span class="sr-only">Close</span></a></div></div></div></div></div>
    </div>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '[[*album:notempty=`<section class="mbr-gallery mbr-slider-carousel cid-r9O7JQleK9" id="gallery3-1j">
    ...
    <div>
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '[[*content:notempty=`<section class="mbr-section article content1 cid-r9O8cxOcZJ" id="content1-1l">
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-12 mbr-fonts-style display-7">
                [[*content]]
          ...
          'static' => false,
          'static_file' => '',
          'content' => '[[*content:notempty=`<section class="mbr-section article content1 cid-r9O8cxOcZJ" id="content1-1l">
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-12 mbr-fonts-style display-7">
                [[*content]]
...
<section class="features16 cid-r9ZjmeHVpQ" id="features16-1n">
    ...
    <div class="container align-center">
        ...
        <div class="row media-row">
        [[getResources? &parents=`3` &tpl=`teamTpl` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &sortby=`{"menuindex":"DESC"}` &limit=``]]
        </div>    
    </div>
</section>
[[$content]]',
...
[[$content]]',
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section class="features11 cid-r9HiZB98pu" id="features11-g">
    ...
    <div class="container">   
        <div class="col-md-12">
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="features11 cid-r9HiZB98pu" id="features11-g">
    ...
    <div class="container">   
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section class="testimonials1 cid-r9HGZkKJef" id="testimonials1-r">
    ...
    <div class="container pt-3 mt-2">
        <div class="media-container-row" style="align-items: stretch;">
            [[getResources? &parents=`4` &tpl=`revTpl` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &sortby=`{"menuindex":"DESC"}` &limit=``]]
        </div>
    </div>   
</section>',
          'locked' => false,
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="testimonials1 cid-r9HGZkKJef" id="testimonials1-r">
...
[[$map]]',
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section class="features1 cid-r9ZlVjTK8e" id="features1-1u">
...
<br>190th Street</p>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="features1 cid-r9ZlVjTK8e" id="features1-1u">
...
<br>190th Street</p>
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1649.9856070675683!2d-118.4517668417612!3d34.19821189514163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c297182fd4eff9%3A0x974cc23dd967f272!2s14554+Vose+St%2C+Van+Nuys%2C+CA+91405!5e0!3m2!1sru!2sus!4v1542753185747" width="100%" height="550" frameborder="0" style="border:0" allowfullscreen></iframe>',
          'locked' => false,
          'properties' => 
          array (
          ),
          'static' => false,
          'static_file' => '',
          'content' => '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1649.9856070675683!2d-118.4517668417612!3d34.19821189514163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c297182fd4eff9%3A0x974cc23dd967f272!2s14554+Vose+St%2C+Van+Nuys%2C+CA+91405!5e0!3m2!1sru!2sus!4v1542753185747" width="100%" height="550" frameborder="0" style="border:0" allowfullscreen></iframe>',
        ),
        'policies' => 
        array (
        ),
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section class="mbr-section form1 cid-r9HA8NkyYb mbr-parallax-background" id="form1-o">
 ...
 a quote from our experts</strong></h2>
    ...
    <div class="container">
        <div class="row justify-content-center">
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="mbr-section form1 cid-r9HA8NkyYb mbr-parallax-background" id="form1-o">
    ...
    &emailSubject=`[[++site_name]]`
      ...
      array (
        ...
        array (
          ...
          'category' => 3,
          'cache_type' => 0,
          'snippet' => '<section class="cid-r9HCkSRO2n mbr-reveal" id="footer1-p">
...
<script src="assets/web/assets/jquery/jquery.min.js"></script>
  ...
  [[*album:notempty=`<script src="assets/masonry/masonry.pkgd.min.js"></script>
    ...
    <script src="assets/imagesloaded/imagesloaded.pkgd.min.js"></script>`]]',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="cid-r9HCkSRO2n mbr-reveal" id="footer1-p">
...
<script src="assets/web/assets/jquery/jquery.min.js"></script>
  ...
  [[*album:notempty=`<script src="assets/masonry/masonry.pkgd.min.js"></script>
    ...
    <script src="assets/imagesloaded/imagesloaded.pkgd.min.js"></script>`]]',
      ...
      array (
        ...
        array (
          ...
          'category' => 1,
          'cache_type' => 0,
          'snippet' => '<form class="mbr-form" action="[[~[[*id]]]]" method="post">
    <input type="hidden" name="nospam:blank" value="">
    <input type="hidden" value="1" name="btn">
    <div class="row row-sm-offset">
        <div class="col-md-4 multi-horizontal" data-for="name">
            <div class="form-group">
                <label class="form-control-label mbr-fonts-style display-7" for="name-form1-o">Name<span class="errors error_name">[[!+fi.error.name]]</span></label>
                <input type="text" class="form-control" name="name" data-form-field="Name" required=""  id="name" value="[[!+fi.name]]">
            </div>
        </div>
        <div class="col-md-4 multi-horizontal" data-for="email">
            <div class="form-group">
                <label class="form-control-label mbr-fonts-style display-7" for="email-form1-o">Email<span class="errors error_email">[[!+fi.error.email]]</span></label>
                
                <input type="email" class="form-control" name="email" data-form-field="Email" required="" value="[[!+fi.email]]" id="email">
            </div>
        </div>
        <div class="col-md-4 multi-horizontal" data-for="phone">
            <div class="form-group">
                <label class="form-control-label mbr-fonts-style display-7" for="phone-form1-o">Phone<span class="errors error_phone">[[!+fi.error.phone]]</span></label>
                <input type="tel" class="form-control" name="phone" data-form-field="Phone"  required="" value="[[!+fi.phone]]" id="phone">
            </div>
        </div>
    </div>
    <div class="form-group" data-for="message">
        <label class="form-control-label mbr-fonts-style display-7" for="message-form1-o">Message<span class="errors error_text">[[!+fi.error.text]]</span></label>
        <textarea type="text" class="form-control" name="message" rows="7" data-form-field="Message" id="text">[[!+fi.text]]</textarea>
    </div>
    ...
    <span class="input-group-btn"><button href="" type="submit" class="btn btn-primary btn-form display-4">Send request</button></span>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<form class="mbr-form" action="[[~[[*id]]]]" method="post">
    <input type="hidden" name="nospam:blank" value="">
    <input type="hidden" value="1" name="btn">
    <div class="row row-sm-offset">
        <div class="col-md-4 multi-horizontal" data-for="name">
